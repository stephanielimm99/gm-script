...
function createApkBox() {
    ...
    <div class="maxwin-box">
      <div class="left-panel">
        ...
        <button class="main-link" type="button" id="copyMainLinkBtn">
          altwin.link/gacormania
        </button>

        <div class="label">Pilih Link Alternatif:</div>

        <select id="altLink">
          <option value="https://gm.akses-gampang.com">gm.akses-gampang.com</option>
          <option value="https://gm1.akses-gampang.com">gm1.akses-gampang.com</option>
          <option value="https://gm2.akses-gampang.com">gm2.akses-gampang.com</option>
        </select>
  ...
  if (copyMainLinkBtn) {
    copyMainLinkBtn.addEventListener("click", function () {
      const value = "https://altwin.link/gacormania";
